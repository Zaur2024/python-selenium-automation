...
#homework N4.2
  Scenario: Verify Join Target Circle
    ...
    And Click on Join Target Circle
    Then Verify Sign into your Target account page shown


  Scenario: Verify see today's Target Circle deals
  ...
  Scenario: Verify Target Circle Bonuses
  ...
  Scenario: Verify Target Circle Partners
  ...
  Scenario: Verify Community support votes
  ...
  Scenario: Verify Gift a membership
  ...
  Scenario: Save over 50% with government assistance
